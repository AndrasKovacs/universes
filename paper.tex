...
%% \begin{notation}
%% Given $p : i < j$ we may write $\Lift_{i}^{j}\,p : \Ty_i\,\Gamma \to
%% \Ty_j\,\Gamma$ for type lifting, and $\up_{i}^{j}p$ and $\down_{i}^{j}p$
%% accordingly for term lifting. Sometimes we omit $i$, $j$ and $p$ annotations,
